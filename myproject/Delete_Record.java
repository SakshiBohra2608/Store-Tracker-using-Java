...
public class Delete_Record extends JFrame {
	...
	Delete_Record(){
		...
		jtx.setFont(new Font("Consolas",Font.BOLD,18));
		jbt=new JButton("Done");
		jbt.setBackground(new Color(201, 226, 195));
        jbt.setBorder(BorderFactory.createLineBorder(Color.white,2,true));
        jbt.setFont(new Font("Consolas",Font.BOLD,18));
        panel.setBackground(new Color(225, 245, 218));
