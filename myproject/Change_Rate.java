...
public class Change_Rate extends JFrame {
	...
	Change_Rate(){
		...
		jbt.setFont(new Font("Consolas",Font.BOLD,22));
		panel.add(label1);
		panel.add(jtx);
        ...
        panel.setBackground(new Color(199,215,202));

		
		 jbt.setBackground(new Color(124,130,107));
	     jbt.setBorder(BorderFactory.createLineBorder(Color.white,2,true));
