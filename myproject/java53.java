...
class Bill extends JFrame{
	...
	Bill(){
		...
		lbl1.setFont(new Font("Consolas",Font.BOLD,16));
	    lbl2=new JLabel("              ENTER QUANTITY");
	    lbl2.setFont(new Font("Consolas",Font.BOLD,16));
	    ...
	    add=new JButton("ADD");
	    add.setBackground(new Color(86,82,100));
	    add.setForeground(Color.white);
        add.setBorder(BorderFactory.createLineBorder(Color.white,2,true));
        add.setFont(myFont);
	    show=new JButton("SHOW BILL");
	    show.setBackground(new Color(86,82,100));
	    show.setForeground(Color.white);
        show.setBorder(BorderFactory.createLineBorder(Color.white,2,true));
        show.setFont(myFont);
	   ...
	   show.addActionListener(listener2);
	    ...
	    p1.add(show);
	    add(p1);
	    p1.setBackground(new Color(191,171,203));
	...
	class  showClass implements ActionListener{
        ...
        fcash.seek(28);
	      ...
	      jf.setBackground(new Color(255,228,225));
	...
	class Custclass implements ActionListener {
		...
		public void actionPerformed(ActionEvent e){
			...
			jp.setBackground(new Color(255,228,225));
			
			save.setBackground(new Color(188,143,143));
			text1.setBackground(new Color(245,255,250));
			text2.setBackground(new Color(245,255,250));
